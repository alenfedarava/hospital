...
CREATE TABLE IF NOT EXISTS `hospital`.`Administration` (
  ...
  `personalRoom` TINYINT(1) NOT NULL,
  `HospitalStaff_ID` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE INDEX `idAdministration_UNIQUE` (`ID` ASC),
  INDEX `fk_Administration_HospitalStaff1_idx` (`HospitalStaff_ID` ASC),
  CONSTRAINT `fk_Administration_HospitalStaff1`
...
CREATE TABLE IF NOT EXISTS `hospital`.`Medical` (
  ...
  INDEX `fk_Medical_HospitalStaff1_idx` (`HospitalStaff_ID` ASC),
  CONSTRAINT `fk_Medical_HospitalStaff1`
    FOREIGN KEY (`HospitalStaff_ID`)
    REFERENCES `hospital`.`HospitalStaff` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `hospital`.`ChiefAccountant` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_ChiefAccountant_Administration1_idx` (`Administration_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `hospital`.`ChiefMedical` (
  ...
  `Administration_ID` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_ChiefMedical_Administration1_idx` (`Administration_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `hospital`.`GeneralPractice` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_GeneralPractice_Medical1_idx` (`Medical_ID` ASC),
